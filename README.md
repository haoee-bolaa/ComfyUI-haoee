...
5.  打开ComfyUI云端工作台：[https://cl.haoee.com/main/home](https://cl.haoee.com/main/home)，注册或登录

6.  确保账户有余额或充值

7.  进入工作流市场，选择需要使用的API模型对应的工作流（以Gemini image为例）

8.  打开工作流以后，找到“好易API key“这个节点，把上面复制的key填入
...
9.  好易API key账号就可以在工作流里面进行扣费了

## ****第三步：费用说明****

10.  运行带有API key的工作流费用包含：运行工作流调度的算力费用+API的调用费用

11.  工作流调度的算力费用对应：ComfyUI云端工作台的账户：[https://cl.haoee.com/](https://cl.haoee.com/)，按工作流运行时长扣费，大约0.002分/秒

12.  API调用的费用对应的账户：[<u>https://www.haoee.com/maas/services?ic=VUZUlOJo</u>](https://www.haoee.com/maas/services?ic=VUZUlOJo)，具体调用模型调用价格请查看：好易智算Maas模型服务板块

13.  现目前在ComfyUI里面，API key调用好易Maas模型，以正式渠道价格的为准，确保用户工作流运行的稳定性

14.  以运行一次：gemini-image 工作流 2K图片为例，消耗的费用为：
